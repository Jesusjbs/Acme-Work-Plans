...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.authenticated" access="hasRole('Authenticated')">
			<acme:menu-suboption code="master.menu.authenticated.public-finished-tasks" action="/authenticated/task/list-public-finished"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.manager" access="hasRole('Manager')">
			<acme:menu-suboption code="master.menu.manager.create-task" action="/management/task/create"/>
			<acme:menu-suboption code="master.menu.manager.tasks" action="/management/task/list"/>
			<acme:menu-separator/>
			<acme:menu-suboption code="master.menu.manager.create-workplan" action="/management/workplan/create"/>
			<acme:menu-suboption code="master.menu.manager.workplans" action="/management/workplan/list"/>
		</acme:menu-option>
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account" access="isAuthenticated()">
			...
			<acme:menu-suboption code="master.menu.user-account.become-administrator" action="/authenticated/administrator/create" access="!hasRole('Administrator')"/>
		</acme:menu-option>
